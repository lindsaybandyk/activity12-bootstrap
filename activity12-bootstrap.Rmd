...
I would argue that due to the CLT, a sample statistic will conform to an approximately normal distribution with a large number of samples (no matter what the distribution is of the population).  Thus, we can reasonably assume the distribution of the sample mean is normal.
